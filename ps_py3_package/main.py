...
if __name__=="__main__":
   ...
   if args.pfile == None:
      ...
      #Create kernels
      cl = cpool.CLEFT(pfile = args.pfile, npool = args.npool, qfile = args.qfile, rfile = args.rfile, saveqfile=None);
      ##Save them
      if args.saveq: cpool.save_qkernel(cl, qfile)
      if args.saver: cpool.save_rkernel(cl, rfile)
      if args.saveqfunc: cpool.save_qfunc(cl, qfuncfile)
      #Calculate spectrum
