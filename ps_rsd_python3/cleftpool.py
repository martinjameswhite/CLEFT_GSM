...
class CLEFT():
    ...
    Stolen from Chirag's code with minor modifications to: sum over fewer bessels, make loop corrections optional, list will probably grow
    '''
